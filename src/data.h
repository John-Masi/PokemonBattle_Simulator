...
namespace SpeciesTable {
  ...
  Species charmeleon{"charmeleon",58,64,58,80,65,80,Type::fire};
  Species charizard{"charizard",78,84,78,100,85,109,Type::fire,Type::flying};
  Species caterpie{"caterpie",45,30,35,45,20,20,Type::bug};
  Species metapod{"metapod",50,20,55,30,25,25,Type::bug};
  Species butterfree{"butterfree",60,45,50,70,80,90,Type::bug,Type::flying};
  Species dragonite{"dragonite",91,134,95,80,100,100,Type::dragon,Type::flying};
};
